<form class="settings" name="frmPixel" id="frmPixel" method="POST" novalidate="novalidate">
	...
	<div class="form-group">
		...
		<label class="description">Use {source}, {campaign} to receive traffic source info,<br>and {event} placeholder to get type of conversion, available events: 'register','authenticated','payment'</label>
	</div>
